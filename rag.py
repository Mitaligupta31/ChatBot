...
from langchain_huggingface.embeddings import HuggingFaceEmbeddings #Text_to_Vector
...
def initiliaze_components(): #good practice to create function
    ...
    if vector_store is None:
        ...
        vector_store = Chroma(
            ...
            persist_directory=str(VECTOR_STORE_DIR) #path should be in string only 
        )
...
def process_urls(urls):
    ...
    :return : generator yielding tatus messages
    """
    
    yield "Initializing components...✅"
    initiliaze_components()
